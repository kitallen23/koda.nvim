...
Extra color configs for [WezTerm](extras/wezterm/) and [Ghostty](extras/ghostty/), can be found in [extras](extras/). To use them, refer to their respective documentation.
